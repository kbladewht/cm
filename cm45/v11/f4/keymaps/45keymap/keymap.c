...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = { \
	...
	{ KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_UP, KC_N, KC_NO}, \
    { KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_NO, KC_NO, KC_LEFT, KC_RIGHT}  \
},
  [1] = { \
	{ KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, RGB_TOG}, \
...
{42,  41,  40,  39,  NO_LED, NO_LED, 38, 37}
...
{18,51},{61,51},{89,51},{117,51},{145,51},{173,51},{201,51}, 
{222,64},{196,64},{141,64},          {76,64},{40,64},{3,64},
//U_RGB
       {208,64},
{190,62},      {222,62},
{190,60},      {222,60},
